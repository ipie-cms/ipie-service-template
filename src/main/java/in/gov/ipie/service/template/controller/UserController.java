...
import in.gov.ipie.service.template.mapper.UserApiMapper;
...
import in.gov.ipie.service.template.service.UserService;
import in.gov.ipie.service.template.domain.User;
import in.gov.ipie.service.template.domain.UserSearchCriteria;
import in.gov.ipie.service.template.domain.UserSortField;
...
public class UserController {
    ...
    public PageResponse<UserResponse> searchUsers(
        ...
        PageResult<User> result = userService.searchUsers(criteria, pageRequest);
    ...
    public CursorPageResponse<UserResponse> searchUsersAfter(
        ...
        CursorPageResult<User> result = userService.searchUsersAfter(criteria, pageRequest);
    ...
    public UserResponse reactivateUser(@PathVariable UUID id) {
        return userApiMapper.toResponse(userService.reactivateUser(id));
    }
}
