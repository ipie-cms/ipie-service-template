...
class EventStoreConfig {
    ...
    OutboxStore outboxStore(EntityManager entityManager, ObjectMapper objectMapper) {
        return new JpaOutboxStore<>(entityManager, objectMapper, OutboxEventJpaEntity.class, OutboxEventJpaEntity::new);
    }

    @Bean
    ProcessedEventStore processedEventStore(EntityManager entityManager) {
        return new JpaProcessedEventStore<>(entityManager, ProcessedEventJpaEntity.class, ProcessedEventJpaEntity::new);
    }
}
