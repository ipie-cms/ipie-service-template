...
public class CommonI18nExample {
    ...
    /**
     * The example needs the supported locales, not the properties object. Copying the list at
     * construction keeps a Spring-bound, mutable @ConfigurationProperties bean out of a field here.
     */
    private final List<Locale> supportedLocales;

    public CommonI18nExample(MessageResolver messageResolver, IpieI18nProperties i18nProperties) {
        this.messageResolver = messageResolver;
        this.supportedLocales = List.copyOf(i18nProperties.getSupportedLocales());
    }
